-- Extra configuration for the Cmake plugin, which introduces a similar
-- convenient workflow like the Cmake tools extension for vscode
--

--NOTE For Configure and Build: it uses:
--[[
    mkdir Step1_build
    cd Step1_build
...
local cmake_ft = ' CmakeLists.txt'

return {
    event = { 'BufRead' .. cmake_ft, 'BufNewFile' .. cmake_ft },
